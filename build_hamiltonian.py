from modular_arithmetic import circ_shift, digits_str_to_num, to_base
from basis_construction import get_momentum_projection, get_period, construct_period_table, construct_momentum_table,pprint_period_table
import numpy as np
...
if __name__ == "__main__":
    nsites = 4
    period_table = construct_period_table(nsites,base=3)
    #pprint_period_table(period_table,3)
    momentum_table = construct_momentum_table(period_table,base=3)
    #print(period_table)
    ...
    for momentum in momentum_table.keys():
